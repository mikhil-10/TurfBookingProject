	...
	<section style="background-color: #262525; margin-top: 60px;">
		...
		<div class="container">
			...
			<form id="registrationForm" method="post"
				action="CricketFormController3">

				<h1>
					<label for="groundName">Ground Name: 
				</h1>
				</label> 
				<input type="text" id="groundName" name="groundName"
					value="Cricket Ground 3" readonly> <br> <br>
				<h1>
					<label for="price">Price : 
				</h1>
				</label> <input type="text" id="price" name="price" value="1000.00" readonly>
				<br> <br>
