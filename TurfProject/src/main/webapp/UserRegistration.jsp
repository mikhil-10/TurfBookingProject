...
<body>
	<nav>
		<div class="navbar">
			...
			<a href="Home.jsp">Home</a> <a href="UserLogin.jsp">Booking Details</a> <a
				href="https://goo.gl/maps/c4yDQcBTBUxHG2Qm9">Location</a> <a
	...
	<div class="container">
		...
		<hr>
		<form id="registrationForm" method="post" action="Booking.jsp">

			<h1>
				<label for="groundName">Ground Name: 
			</h1>
			</label> <input type="text" id="groundName" name="groundName"
				value="Cricket" readonly> <br> <br>
			<h1>
				<label for="price">Price : </label>
			</h1>
			 <input type="text" id="price" name="price" value="2000.00" readonly>
			<br> <br>
