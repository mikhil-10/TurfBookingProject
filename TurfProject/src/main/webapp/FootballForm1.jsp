...
<body>
	...
	<section style="background-color: #262525; margin-top: 60px;">
		...
		<div class="container">
			...
			<hr>
			<form id="registrationForm" method="post" action="FootballFormController1">

				<h1>
					<label for="groundName">Ground Name: </label>
				</h1> <input type="text" id="groundName" name="groundName"
					value="Football Ground 1" readonly> <br> <br>
				<h1>
					<label for="price">Price : </label>
				</h1>
				 <input type="text" id="price" name="price" value="2500.00" readonly>
				<br> <br>
