...
@WebServlet("/FootballFormController2")
public class FootballFormController2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        registration.setGroundName("Football Ground 2");
        registration.setPrice(2000.00);
