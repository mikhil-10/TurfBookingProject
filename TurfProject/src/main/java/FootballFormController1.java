...
@WebServlet("/FootballFormController1")
public class FootballFormController1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        registration.setGroundName("Football Ground 1");
        registration.setPrice(2500.00);
