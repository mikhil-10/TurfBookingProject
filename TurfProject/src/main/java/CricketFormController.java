...
@WebServlet("/CricketFormController")
public class CricketFormController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        registration.setGroundName("Cricket Ground 1");
        registration.setPrice(1800.00);
